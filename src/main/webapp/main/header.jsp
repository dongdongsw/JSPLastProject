                            ...
                            <ul class="navbar-nav" id="yummy-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="yummyDropdown">
                                        ...
                                        <%-- 네이버 카페 / 블로그 : 형태소 분석 --%>
                                        <a class="dropdown-item" href="single.html">레시피검색</a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="yummyDropdown">
                                        <a class="dropdown-item" href="../goods/list.do?cno=1">전체상품</a>
                                        
                                        <a class="dropdown-item" href="../goods/list.do?cno=2">신상품</a>
                                        
                                        <a class="dropdown-item" href="../goods/list.do?cno=3">베스트상품</a>
                                        
                                        <a class="dropdown-item" href="../goods/list.do?cno=4">특가상품</a>
                                    </div>
                                </li>
                                 <li class="nav-item dropdown">
